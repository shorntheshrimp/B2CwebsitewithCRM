        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                <div class="section-tittle mb-60 text-center wow fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
                    <h2 style="font-size: 50px">What we are<br></h2><br>
                    <p style="font-size: 18px">DIYone comes from humble beginnings, with the ever-growing love for personal home projects. Share, explore, and find what you need in DIY one. There is always something for everyone here.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-product mb-50">
                            ...
                            <div class="location-details">
                                <p><a href="https://www.wired.com/gallery/how-to-build-a-home-tool-kit/" target="_blank" style="text-shadow: black 0px 0px 4px;"><?php echo $admin1-> text ?><br></a></p>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="section-tittle mb-60 text-center wow fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
                    <h2 style="font-size: 50px">DIYone<br>Craftsmen</h2>
                </div>
            </div>
        </div>
