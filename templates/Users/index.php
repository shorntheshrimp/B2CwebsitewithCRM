                        ...
                        <table border="3" cellspacing="0" cellpadding="3">
                            ...
                            <?php foreach ($users as $key => $user): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['action' => 'view', $user->id],['class'=>'fas fa-eye']) ?>
                                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $user->id],['class'=>'fas fa-edit']) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user->id], ['class'=>'fas fa-trash','confirm' => __('Are you sure you want to delete # {0}?', $user->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
